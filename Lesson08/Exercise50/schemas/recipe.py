...
class RecipePaginationSchema(PaginationSchema):
    data = fields.Nested(RecipeSchema, attribute='items', many=True)#attribute = 'items' означает, что он получает исходные данные из элементов для атрибуции в объектах разбивки на страницы .
